export function History() {
    ...
    return (
        <div>
            <div className="mt-6">
                <h2 className="text-2xl font-medium tracking-tight text-zinc-300 w-full pt-6">Histórico</h2>
            </div>
            <div>
                <table className="w-full border-collapse mt-4">
                    ...
                    <tbody className="pb-6">
                        {dados.map((item, index) => (
                            ...
                            >
                                <td
                                    className="px-4 py-2 border-b border-zinc-900 text-lg font-medium text-zinc-700 "
                                >       
                                    {item.dataHora}
                                </td>
                                <td
